...
**	INP:	axis    : X axis 0, Y axis 1
**			iq_ref	: q-axis reference current (id_ref = 0.0)
...
*/
void currrent_ctrl_dtc(float iq_ref, float theta_e, float vdc_ad, float *vu_ref, float *vv_ref, float *vw_ref);
