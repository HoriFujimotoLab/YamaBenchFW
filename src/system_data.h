...
#define		Kt		(0.172668006987608)		// Torque constant		[Nm/A]
...
#define 	FF 		(1000.0)				// Filter cutoff freq 	[Hz]
...
// MSR VAR
extern float vdc_adx, idc_adx, theta_ex;
...
extern float theta_mx, theta_mox, theta_mdx, omega_mx, omega_max;
